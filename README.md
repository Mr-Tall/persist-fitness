...
Persist Fitness is built to show that you can design and implement a practical, production‑style app end to end: from database modeling and backend APIs to a modern, responsive frontend and AI‑assisted features. It emphasizes clean architecture, real‑world workflows, and technologies that are common in industry, all while staying deployable on free tiers.

## Core User Experience

At its core, Persist Fitness gives users three main workflows:

### 1. Log workouts with real detail

- Create workouts and add exercises.
- Record sets with reps, weight, RIR, tempo, and notes.
- Review history by date, track volume trends, and spot progress in specific lifts or muscle groups.

### 2. Explore exercises and tutorials

- Search and filter a full exercise library by muscle group, equipment, or difficulty, backed by an open exercise dataset such as **free-exercise-db**.
- View key information for each exercise: target muscles, equipment, and “how‑to” instructions.
- Use the exercise explorer as a built‑in tutorial browser to learn new movements safely and effectively.

### 3. Get AI‑assisted guidance

- Request workout suggestions based on goals (e.g., strength vs hypertrophy), available equipment, time, and recent training history.
- Receive structured workout templates that can be logged or customized.
- Get concise form cues for specific exercises to help avoid common mistakes.
...
- View past sessions, personal records, and weekly or monthly training volume.
...
- Detail pages describing the exercise, cues, and safety notes so users know how to perform movements correctly.
...
- **Post‑workout:** cool‑down ideas and a reflection screen for RPE and notes, feeding back into future AI suggestions.
...
- Styled with a utility‑first CSS framework and a component library for a smooth, responsive, and interactive UI that feels like a serious training tool, not a toy.

### Backend and data

- A relational database models users, profiles, exercises, workouts, sets, and templates to reflect real‑world schema design.
- The exercise catalog is seeded from a free, open database such as **free-exercise-db**, providing a large, realistic dataset.
...
- Requests are grounded in the user’s profile and recent logs so suggestions feel personalized instead of generic boilerplate.
